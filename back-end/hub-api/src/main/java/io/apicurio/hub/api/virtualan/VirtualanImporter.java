...
/**
 * A Virtualan importer.
 *
 * @author elan.thangamani@virtualan.io
 */
public class VirtualanImporter {
    ...
    private VirtualanSecretRef secretRef;
    ...
    public VirtualanSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(VirtualanSecretRef secretRef) {
